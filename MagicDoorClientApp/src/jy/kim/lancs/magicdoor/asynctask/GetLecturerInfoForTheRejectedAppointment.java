...
public class GetLecturerInfoForTheRejectedAppointment extends AsyncTask<String, Void, UserAccountInfoBean> {

	private ProgressDialog dialog;
	private Context context;

	public GetLecturerInfoForTheRejectedAppointment(Context context) {
	...
	@Override
	protected UserAccountInfoBean doInBackground(String... params) {
		// TODO Auto-generated method stub
	...
	@Override
	protected void onPostExecute(UserAccountInfoBean result) {
		// TODO Auto-generated method stub
		dialog.dismiss();
