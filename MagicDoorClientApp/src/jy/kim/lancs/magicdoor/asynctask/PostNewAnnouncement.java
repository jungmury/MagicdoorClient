...
public class PostNewAnnouncement extends
		AsyncTask<AnnouncementReqBean, Void, ArrayList<AnnouncementRespBean>> {

	private ProgressDialog dialog;
	private Context context;

	public PostNewAnnouncement(Context context) {
	...
	@Override
	protected ArrayList<AnnouncementRespBean> doInBackground(
		...
		try {
			...
			StringEntity json = JsonUtil.getJsonNewAnnouncement(params);
