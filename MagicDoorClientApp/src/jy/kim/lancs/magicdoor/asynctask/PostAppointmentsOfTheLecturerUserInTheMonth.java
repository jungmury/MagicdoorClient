...
public class PostAppointmentsOfTheLecturerUserInTheMonth
		extends
		AsyncTask<QueryForAppointments, Void, ArrayList<AppointmentRespDetailBean>> {

	private ProgressDialog dialog;
	private Context context;

	public PostAppointmentsOfTheLecturerUserInTheMonth(Context context) {
	...
	protected ArrayList<AppointmentRespDetailBean> doInBackground(
		...
		try {
			...
			StringEntity json = JsonUtil
					.getJsonQueryForAppointmentsWithDateOnly(params);
