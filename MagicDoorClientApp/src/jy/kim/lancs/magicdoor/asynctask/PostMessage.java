...
public class PostMessage extends
		AsyncTask<MessageBean, Void, ArrayList<MessageBean>> {
	...
	@Override
	protected ArrayList<MessageBean> doInBackground(MessageBean... params) {
		// TODO Auto-generated method stub
		...
		try {
			...
			StringEntity json = JsonUtil.getJsonNewMessage(params);
