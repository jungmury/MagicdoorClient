...
public class GetDayTimeTable extends
		AsyncTask<QueryForTimeTable, Void, ArrayList<TimeTableBean>> {

	private ProgressDialog dialog;
	private Context context;

	public GetDayTimeTable(Context context) {
