...
public class GETNFCTagsInfo extends
		AsyncTask<String, Void, ArrayList<NFCTagInfoBean>> {

	private Context context;
	private ProgressDialog dialog;

	public GETNFCTagsInfo(Context context) {
	...
	@Override
	protected ArrayList<NFCTagInfoBean> doInBackground(String... params) {
		// TODO Auto-generated method stub
