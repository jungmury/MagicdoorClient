...
public class PostNFCTag extends
		AsyncTask<NFCTagInfoBean, Void, ArrayList<NFCTagInfoBean>> {

	private ProgressDialog dialog;
	private Context context;

	public PostNFCTag(Context context) {
	...
	@Override
	protected ArrayList<NFCTagInfoBean> doInBackground(NFCTagInfoBean... params) {
		// TODO Auto-generated method stub
		...
		try {
			StringEntity json = JsonUtil.getJsonTagInfo(params);
			...
			if (entity != null) {
				...
				try {
					...
					result = mapper.readValue(entity.getContent(),
							new TypeReference<ArrayList<NFCTagInfoBean>>() {
							});
	...
	@Override
	protected void onPostExecute(ArrayList<NFCTagInfoBean> result) {
		// TODO Auto-generated method stub
		dialog.dismiss();
	}
